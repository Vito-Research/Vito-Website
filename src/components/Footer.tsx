...
function Footer() {
  return (
    <div className="section footer" id="footer">
      ...
      <p><a className="footer-text footer-text-space" href="https://www.nature.com/articles/s41746-021-00422-7">[1] Modeling the effect of exposure notification and non-pharmaceutical interventions on COVID-19 transmission in Washington state </a></p>
        ...
        <div className="footer-div footer-div-space">
          ...
          <p><a className="footer-text" href="https://share.streamlit.io/andreasink/vito-visualization/main/vito_visualization_tools/main.py">Streamlit</a></p>
